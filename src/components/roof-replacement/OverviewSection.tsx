      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            <h2 className="text-3xl font-heading font-bold text-navy mb-6 text-left">When Is It Time for a Roof Replacement?</h2>
            ...
            <p className="text-charcoal/80 mb-4 text-left">
              Common signs that indicate your roof needs replacement include:
            </p>
            <ul className="list-disc pl-6 mb-6 text-charcoal/80 space-y-2 text-left">
