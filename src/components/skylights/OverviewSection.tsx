      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            <h2 className="section-title text-center md:text-left">Bring Natural Light Into Your Home</h2>
            ...
            <div className="flex items-center gap-2 text-stark-red mb-4 justify-center md:justify-start">
              <Sun size={20} />
