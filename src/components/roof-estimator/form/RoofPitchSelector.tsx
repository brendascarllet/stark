...
const RoofPitchSelector: React.FC<RoofPitchSelectorProps> = ({ roofPitch, setRoofPitch, roofPitches }) => {
  return (
    <div>
      <h3 className="text-xl font-bold text-navy mb-4">3. Roof Pitch (Steepness)</h3>
