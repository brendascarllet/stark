    ...
    <section className="hero-overlay relative pt-32 pb-20 md:py-32">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          <motion.div
            className="inline-flex items-center bg-stark-red text-white px-5 py-1.5 rounded-full mb-8 font-semibold text-sm"
          ...
          <div className="w-20 h-1 bg-stark-red mb-8 mx-auto"></div>
          ...
          <p
            className="text-xl text-white/90 mb-10 max-w-2xl mx-auto animate-fade-in font-medium drop-shadow-md leading-relaxed"
          ...
          >
            <a
              href="#contact"
              className="btn-primary inline-flex items-center bg-stark-red hover:bg-stark-red/90"
            >
            ...
            <a
              href="#process"
              className="btn-secondary border-stark-red text-stark-red hover:bg-stark-red hover:text-white"
            >
              How It Works
            </a>
          </div>
